...
We’ve added the code below to the HTML. Now, we loop over $records (the variable containing the records we got with SELECT) once per entry to generate our list. This is explained in more detail in the comments below.
...
?>
                    <li><?php print $book_title; ?></li>         // li要素内に$book_titleを出力する
<?php
                }
            }
?>
